...
def load_data():
    with app.app_context():
        ...
        users_df = pd.read_csv('data/cleaned/users.csv')
        ...
        admins_df = pd.read_csv('data/cleaned/admin_users.csv')
        ...
        movies_df = pd.read_csv('data/cleaned/movies.csv')
        ...
        rentals_df = pd.read_csv('data/cleaned/rentals.csv')
        ...
        payments_df = pd.read_csv('data/cleaned/payments.csv')
        ...
        reviews_df = pd.read_csv('data/cleaned/reviews.csv')
